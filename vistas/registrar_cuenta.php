    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <form  class="form-horizontal" name="regis" id="regis" method="POST" action="../controles/c_usuarios.php">
                    <div>

                      <div class="form-group">
                        <label class="control-label col-xs-2"> Cédula: </label>
                        <div class="col-xs-10">
                          <input class="form-control" style="width: 70%;" placeholder="Ingresar cédula" type="number" name="cedula" id="cedula" required>
                      </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-xs-10">
                          <input placeholder="Ingresar nombre" class='form-control' style="width: 70%;" type="text" name="nombre" id="nombre" required>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-xs-10">
                          <input class="form-control"  placeholder="Ingresar apellido" style="width: 70%;" type="text" name="apellido" id="apellido" required>
                        </div>                        
                      </div>

                      <div class="form-group">
                      <label class="control-label col-xs-2">Institución:</label>
                            <div class="col-xs-10">
                             <!--Select dinamico llama los datos del controlador c_insti2.php trae los datos de las instituciones registradas -->
                             <?php
                         include_once("../controles/c_insti2.php");
                          $elCboin = array();
                          $idtmunicipio= "";
                          $x=0;
                          if( isset($_GET["idtinstitucion"])) 
                          $idtmunicipio = $_GET["idtinstitucion"];
                          $cboin = dibCboIns( $idtmunicipio );
                          foreach ($cboin as $elCboin) 
                          echo $elCboin;
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-xs-10">
                          <input  placeholder="Ingresa su correo" class="form-control"  style="width: 70%;" type="correo" name="correo" id="correo" required>
                        </div>
                        ...
                        <div class="col-xs-10">
                          <input placeholder="Ingresar usuario" class='form-control' style="width: 70%;" type="text" name="usuario" id="usuario" required>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-xs-10">
                          <input placeholder="Nueva contraseña" class="form-control" style="width: 70%;" type="password" name="clave" id="clave" required>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-xs-10">
                          <input placeholder="Confirmar nueva contraseña" class="form-control" style="width: 70%;" type="password" name="clave2" id="clave2" required>
                        </div>
                      ...
                      <div class="form-group">
                         <label class="control-label col-xs-2">Nivel del usuario:</label>
                         <div class="col-xs-10">
                           <select class="form-control" style="width: 70%;" name="nivel" id="nivel">
                     ...
                     <div class="form-group">
                        <label class="control-label col-xs-2">Pregunta secreta:</label>
                        <div class="col-xs-10">
                           <input placeholder="Ingresar su pregunta" class="form-control" style="width: 70%;" type="text" name="pregunta" id="pregunta" required>
                        </div>
                        
                     </div>

                     <div class="form-group">
                       <label class="control-label col-xs-2">Respuesta secreta:</label>
                       <div class="col-xs-10">
                         <input placeholder="Ingresar su respuesta" class="form-control" style="width: 70%;" type="password" name="respuesta" id="respuesta" required>                   
                    ...
                    <center>
                     <button class="btn btn-success" type="submit" onClick="fregistro()" >Guardar</button> 
