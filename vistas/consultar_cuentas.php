...
<script src="../jss/cuentas.js"></script>
...
<body>
    ...
    <table border="0" align="center">
      <tr>
          <td width="335"> <input class="form-control" type="text" placeholder="Buscar usuarios" id="bs-prod"/></td>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>Modificar usuario</b></h4>
            </div>
            <form id="formulario" class="formulario" onsubmit="return agregaRegistro();">
            <div class="modal-body">
        <table border="0" width="80%">
                   <tr>
                        <td colspan="2"><input type="text" required="required" readonly="readonly" id="idtempleado" name="idtempleado" readonly="readonly" style="visibility:hidden; height:5px;"/></td>
                    </tr>
                     <tr>
                     ...
                     <tr>
                      <td>Apellido: </td>
                        <td><input type="text" required="required" name="apellido" id="apellido" maxlength="100"/></td>
                          ...
                          <tr>
                      <td>Correo: </td>
                        <td><input type="correo" required="required" name="correo" id="correo" maxlength="100"/></td>
                    </tr>
                     <tr>
                        <td>Cargo: </td>
                        <td><select required="required" name="cargo" id="cargo">
