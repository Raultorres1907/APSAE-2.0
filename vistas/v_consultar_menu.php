...
<head>
    ...
    <script src="../jss/funciones_menu.js"></script>
...
<body>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                     ...
                     <li>
                        <a href="javascript:;"  data-target="#demo"><i class="fa fa-fw fa-arrows-v"></i> Menu <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="demo" class="collapse in">
                            <li>
    ...
    <table border="0" align="center">
      <tr><!--Acá se coloca el valor con el cual se buscará el menú -->
    ...
    <div class="modal fade" id="registra-producto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <table border="0" width="80%">
                  <!--Acá hay una tabla oculta al momento de modificar el menú -->
                   <tr>
