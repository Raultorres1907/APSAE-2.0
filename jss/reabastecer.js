function fagregar(){
	...
	for(var j =0 ; j<tabla.rows.length;j++){
	 ...
	 if(cont_rep==0){
		...
		td1.innerHTML = "<input type='text' value='"+nombre+"' style='border:transparent;background-color: transparent;width: 50%' readOnly name='nombre"+contador_bienes.value+"'>";
...
function freabastecer()
{
	document.reabastecer.submit();
}