function agregar(){
	...
	for(var j =0 ; j<tabla.rows.length;j++){
	 ...
	 if(cont_rep==0){
		...
		td0.innerHTML = "<input type='text' value='"+nombre+"' name='idMedicamento"+contador_bienes.value+"'>"; 
		td1.innerHTML = "<input type='text' value='"+categoria+"'name='nombre"+contador_bienes.value+"'>";
		td2.innerHTML = "<input type='text' value='"+cantidad+"' name='Cantidad"+contador_bienes.value+"'>";
