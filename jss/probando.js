	...
	//----ESTE FOR ES UTILIZADO PARA NO REPETIR LOS PRODUCTOS QUE SE VAN A GUARD
for(var j =0 ; j<tabla.rows.length;j++){
	 ...
	 if(cont_rep==0){
		...
		td1.innerHTML = "<input type='text' value='"+nombre+"' style='border:transparent;background-color: transparent' readOnly name='nombre"+contador_bienes.value+"'>"; 
		td2.innerHTML = "<input type='text' value='"+proporcion+"' style='border:transparent;background-color: transparent;width: 100%' readOnly name='proporcion"+contador_bienes.value+"'>";
 ...
 i++; //aumentamos la i
		...
		alert("No puedes agregar dos veces "+id+"!");
	}
